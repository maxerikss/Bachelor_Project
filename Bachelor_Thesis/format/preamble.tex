...
%% Macros
\renewcommand{\a}{\hat{a}} % a
\newcommand{\ad}{\hat{a}^{\dagger}} % a dagger
\newcommand{\dt}{\partial_t} % partial t
\newcommand{\dmatrix}{\hat{\rho}} % density matrix
\newcommand{\hamiltonian}{\hat{H}} % Hamiltonian
\newcommand{\nbar}{\bar{n}} % n bar
\newcommand{\xop}{\hat{x}} % x operator
\newcommand{\pop}{\hat{p}} % p operator
\newcommand{\super}[1]{\mathcal{D}[#1]} %super operator
\newcommand{\liouvillian}{\mathcal{L}} % Liouvillian
\newcommand{\feedback}{\mathcal{K}} % feedback super operator
\newcommand{\im}[1]{\mathfrak{I}\left\{#1\right\}} % imaginary part
\newcommand{\re}[1]{\mathfrak{R}\left\{#1\right\}} % real part
